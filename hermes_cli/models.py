...
CANONICAL_PROVIDERS: list[ProviderEntry] = [
    ...
    ProviderEntry("antigravity-acp", "Antigravity CLI (via ACP)", "Antigravity CLI via ACP (agy --print, Gemini Flash / Pro models)"),
...
PROVIDER_GROUPS: dict[str, tuple[str, str, list[str]]] = {
    ...
    "google":   ("Google Gemini",   "AI Studio API, OAuth, or Antigravity ACP",            ["gemini", "google-gemini-cli", "antigravity-acp"]),
